      ...
      <div className="main-content">
        <div className="dashboard-overview">
          ...
          <div className="overview-card borrowers-card">
            <img src="https://res.cloudinary.com/dvjjouwki/image/upload/v1746808931/Vector_3_ofhid8.png" alt="Loans Icon" style={{ width: '48px', height: '48px' }} />
            <div className="card-info">
              <div className="count">
          ...
          <div className="overview-card savings-card">
            <img src="https://res.cloudinary.com/dvjjouwki/image/upload/v1746809040/Vector_4_gku51x.png" alt="Loans Icon" style={{ width: '48px', height: '48px' }} />
            <div className="card-info">
              <div className="count">
          ...
          <div className="overview-card repaid-card">
            <img src="https://res.cloudinary.com/dvjjouwki/image/upload/v1746809103/Vector_5_monot9.png" alt="Loans Icon" style={{ width: '48px', height: '48px' }} />
            <div className="card-info">
              <div className="count">
          ...
          <div className="overview-card loans-card">
            <img src="https://res.cloudinary.com/dvjjouwki/image/upload/v1746814934/Vector_7_y04a6o.png" alt="Loans Icon" style={{ width: '48px', height: '48px' }} />
            <div className="card-info">
              <div className="count">
                {loading ? 'Loading...' : error ? 'Error' : loanCount}
              </div>
              <div className="label">Other Countries</div>
            </div>
          </div>

          <div className="overview-card loans-card">
            <img src="https://res.cloudinary.com/dvjjouwki/image/upload/v1746808077/Vector_2_aitagw.png" alt="Loans Icon" style={{ width: '48px', height: '48px' }} />
            <div className="card-info">
              <div className="count">
                {loading ? 'Loading...' : error ? 'Error' : loanCount}
              </div>
